...
import zw.co.fnc.mobile.rest.DownloadPlanService;
 ...
 * @uthor Tasu Muzinda
 */
public class DownloadPlanActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(receiver, new IntentFilter(DownloadPlanService.NOTIFICATION));
    }
